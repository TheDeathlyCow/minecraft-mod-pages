...
<img src="https://media.githubusercontent.com/media/TheDeathlyCow/minecraft-mod-pages/main/scorchful/assets/sandstorm.png" alt="The visual and gameplay effects of sandstorms."/>
<center>
...
Not a fan of survival? No problem! The visual and audio effects of sandstorms can be downloaded as an entirely separate, standalone client-side mod in [Immersive Storms](https://modrinth.com/mod/immersive-storms)!
...
Scorchful's Neoforge port is very experimental. It is still in alpha, and therefore may contain bugs and cause crashes. The port has also been created in a 'Fabric-like' manner using Forgified Fabric API and custom entry points to minimize the changes needed from the original version, which means that it may not work very well with the Neoforge ecosystem. Proceed with mild caution and please feel free to report issues to the issue tracker. **Scorchful remains a Fabric-first mod and the Neoforge port is not likely to be updated to new Minecraft versions regularly.**