<center>
<img src="https://media.githubusercontent.com/media/TheDeathlyCow/minecraft-mod-pages/main/frostiful/assets/title.png"  alt="Frostiful Title Image"/>
</center>
...
<img src="https://media.githubusercontent.com/media/TheDeathlyCow/minecraft-mod-pages/main/scorchful/assets/try_scorchful.svg" alt="Want something a little warmer? Try Scorchful!"/>
</a>
...
<center>
<img src="https://media.githubusercontent.com/media/TheDeathlyCow/minecraft-mod-pages/main/frostiful/assets/lichen.png"  alt="Sun lichen covered rock in a forest"/>
...
<center>
<img src="https://media.githubusercontent.com/media/TheDeathlyCow/minecraft-mod-pages/main/frostiful/assets/frostologer.png" alt="The Frostologer keeping watch on their Castle wall"/>
...
<center>
<img src="https://media.githubusercontent.com/media/TheDeathlyCow/minecraft-mod-pages/main/frostiful/assets/castle.png"  alt="A picture of the Frostologer's Castle, built from packed snow with icicles hanging from the battlements"/>
...
Frostiful is licensed under [LGPL-3.0](https://www.gnu.org/licenses/lgpl-3.0.en.html). You can use this mod in mod packs, YouTube videos, or anything else. You may copy, modify, and redistribute this mod provided you abide by the terms set forth in the license.

# Configuration

Frostiful is extremely highly configurable. It has an extensive config that lets you play around with different settings, disable features, or tweak the values of various things to adjust the difficulty of the mod. For example, if you're not all that into survival, you can completely disable environmental freezing! It also has a fair amount of datapack integration for more complex things like temperature effects. 
...
Frostiful has a comprehensive player and developer wiki available at https://modded.wiki/w/Frostiful. Thanks to Patbox for hosting this!
...
While this mod is designed to be as compatible as possible with other mods, it is inevitable that sometimes issues will arise. Specific incompatibilities will be documented here and on the [wiki](https://modded.wiki/w/Frostiful#Compatibility) as they become known.
...
This mod uses [Fabric API](https://modrinth.com/mod/fabric-api), [Thermoo](https://modrinth.com/mod/thermoo), [Mod Menu](https://modrinth.com/mod/modmenu), and [YACL](https://modrinth.com/mod/yacl). For Quilt users: replace Fabric API with the [Quilt Standard Libraries](https://modrinth.com/mod/qsl). Some older versions of Frostiful use [Cloth Config](https://modrinth.com/mod/cloth-config), be sure to check the dependencies of the specific version you are downloading.
...
Most everything in this mod is documented on the [wiki](https://modded.wiki/w/Frostiful), but feel free to [join my Discord](https://discord.thedeathlycow.com) and ask any questions about the mod you might have!
